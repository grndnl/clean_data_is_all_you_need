...
def process_documents(
    ...
    # LOAD settings.yaml
    with open("./dla_pipeline_settings.yaml", "r") as file:
    ...
    if model_type == "DIT":
        ...
        MODEL_CONFIG = "./models/dit/object_detection/publaynet_configs/maskrcnn/maskrcnn_dit_base.yaml"
        ...
        MODEL_CONFIG = "./models/layoutlmv3/object_detection/cascade_layoutlmv3.yaml"
