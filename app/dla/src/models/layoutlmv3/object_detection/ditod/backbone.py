...
###############################################################################
# c-notes: Added the following so that it would find 
# `layoutlmft.models.layoutlmv3 `

# TODO: This is very brittle, refactor to have proper directory flow

import os
import sys

def navigate_up(path, levels_up=1):
    for _ in range(levels_up):
        path = os.path.dirname(path)

    return path

parent_directory = navigate_up(os.path.realpath(__file__), 3)
